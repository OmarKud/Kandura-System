...
<div class="wrap">
  <div class="hero">
    ...
    <p>New permission (guard: api).</p>
  </div>

  <div class="card">
    <form method="POST" action="{{ route('dashboard.superadmin.permissions.store') }}">
      @csrf
      <div class="field">
        <div class="label">Name</div>
        <input class="input" name="name" value="{{ old('name') }}" placeholder="e.g. manage_roles" required>
