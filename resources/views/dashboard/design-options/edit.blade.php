...
@section('content')
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:14px;">
        <div>
            <h2 style="margin:0;font-size:18px;font-weight:900;color:#0f172a;">Edit Design Option</h2>
            <div style="margin-top:4px;color:#64748b;font-size:12px;">Update option name + type.</div>
        </div>
    ...
    @if($errors->any())
        <div style="margin-bottom:12px;padding:10px 12px;border-radius:14px;border:1px solid rgba(239,68,68,.25);background:rgba(239,68,68,.08);color:#991b1b;font-size:13px;">
    ...
    <form method="POST" action="{{ route('dashboard.design-options.update', $option->id) }}"
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <div style="flex:1;min-width:220px;">
                ...
                <input name="name[en]" value="{{ old('name.en', $option->getTranslation('name','en')) }}"
            ...
            <div style="flex:1;min-width:220px;">
                ...
                <input name="name[ar]" value="{{ old('name.ar', $option->getTranslation('name','ar')) }}"
                       style="width:100%;padding:10px 12px;border-radius:14px;border:1px solid rgba(15,23,42,.12);outline:none;">
            </div>
        </div>
